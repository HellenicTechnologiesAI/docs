...
OmniAI Chatwoot AWS leftovers live in **Frankfurt** (`eu-central-1`). That delete list is on [OmniAI AWS architecture](/kb/omniai/aws-architecture). Ireland instance is already stopped. Monday: terminate `i-02b985625556f7bd6` and release EIP `34.249.195.203`.
