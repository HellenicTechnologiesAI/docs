...
OmniAI Chatwoot AWS leftovers lived in **Frankfurt** (`eu-central-1`). That history is on [OmniAI AWS architecture](/kb/omniai/aws-architecture). Ireland and Frankfurt leftovers were deleted on 10 September 2026.
