...
Cloudflare `staging` no longer points at the AWS ALB. The ECS service may still be running and still costs money. Public `staging.omniaichatbot.com` is the new Droplet and the app is up.
